    ...
    return (
        <div className='presentacion-contenedor'>
            ...
            <div className='presentacion-introduccion'>
                ...
                <p>Desde entonces, he colaborado con diversas agencias marketing y diseño web participando en una gran variedad de proyectos digitales.</p>
                ...
                <p>Mi ambito de especialización son las tecnologías front-end, aunque con el tiempo he ampliado mis habilidades hacia la experiencia de usuario y la gestión de proyectos web.</p>
                <p>Como profesional en un sector tan dinámico, me mantengo en constante evolución a través de una formación continua, siempre en busca de la optimización y la mejora en mi trabajo.</p>
